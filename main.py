                    ...
                    if mission_description and mission_description.strip():
                        ...
                        try:
                            ...
                            story_response = client.chat.completions.create(
                                model="gpt-4o-mini",
                                messages=[
                                    {"role": "system", "content": "You are a creative children's storyteller inspired by Star Trek adventures. Write engaging stories (at least 4 paragraphs) for children aged 5-10. Use simple, easy-to-understand language. Write short sentences (8-12 words each). Each paragraph must have 5-6 sentences. Stories should be about teamwork, friendship, and space adventures. Respond in JSON format with 'title' and 'story' fields. Title should be catchy and fun (5-10 words). Story should have at least 4 paragraphs with 5-6 short sentences each."},
                                    {"role": "user", "content": f"Write a Star Trek-style adventure story (at least 4 paragraphs) with a catchy title about how these AI agents worked together to complete a mission:\n\nAgents:\n{agent_info}\n\nMission: {mission_description}\n\nRequirements:\n1. Title: A fun, catchy Star Trek-style title (5-10 words)\n2. At least 4 paragraphs, each with exactly 5-6 sentences\n3. Each sentence should be short (8-12 words)\n4. Use simple, easy language for ages 5-10\n5. First paragraph: Agents gather, receive mission briefing, and plan together\n6. Second paragraph: They begin the mission, face first challenges\n7. Third paragraph: They overcome obstacles and work together creatively\n8. Fourth paragraph: Mission success, agents compliment and thank each other\n\nMake it exciting, positive, and suitable for young children! Respond in JSON with 'title' and 'story' fields."}
                                ],
                                response_format={"type": "json_object"},
                                temperature=0.8
                            )
